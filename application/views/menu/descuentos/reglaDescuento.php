            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="table-responsive">
                        ...
                        <a href="<?= $ruta ?>descuentos/pdfExport/<?php echo $id_desc; ?>/" id="generarpdf" class="btn  btn-default btn-lg" data-toggle="tooltip"
                           title="Exportar a PDF" data-original-title="fa fa-file-pdf-o"><i class="fa fa-file-pdf-o fa-fw"></i></a>
                        <a href="<?= $ruta ?>descuentos/excelExport/<?php echo $id_desc; ?>/" id="generarexcel" class="btn btn-default btn-lg" data-toggle="tooltip"
