<form name="formagregar" id="formagregar" action="<?= base_url() ?>subgrupo/guardar" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="nombre" id="nombre" required="true" class="form-control"
                               value="<?php if (isset($subgrupo['nombre_subgrupo'])) echo $subgrupo['nombre_subgrupo']; ?>">
                    </div>

                    <input type="hidden" name="id" id="" required="true"
                           value="<?php if (isset($subgrupo['id_subgrupo'])) echo $subgrupo['id_subgrupo']; ?>">
                </div>
            </div>
