                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <?php if (!isset($ingreso->id_ingreso)): ?>
                                    <div class="col-md-2"><label class="control-label">Precio Unitario: </label> <span
                                                id="precio_unitario">0.0</span></div>
                                <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            ...
                            <a class="btn btn-primary" data-placement="bottom"
                               ...
                               onclick="listarProductos();" <?php if (isset($ingreso->id_ingreso)) echo 'disabled' ?>>Agregar
                                [Enter]</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="$('#confirmarmodal').modal('hide');" aria-hidden="true">
                    &times;
                </button>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" onclick="$('#confirmarmodal').modal('hide');">Cancelar
                </button>
