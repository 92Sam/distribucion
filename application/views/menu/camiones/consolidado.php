            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ventamodalbody">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="suma_metros_cubicos" id="suma_metros_cubicos" value="0"
                                   readonly="readonly"
                                   class=" form-control">
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h4>Presione "Confirmar" para guardar el pedido de todos modos o "Cancelar" para elegir otro
                            camión.</h4>
                    </div>
                    <br><br><br>
