    ...
    <div class="modal-dialog" style="width: 95%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="<?= $ruta ?>inventario/pdfKardex" id="generarpdf" class="btn  btn-danger btn-lg" data-toggle="tooltip" title="Exportar a PDF"
                   data-original-title="fa fa-file-pdf-o"><i class="fa fa-file-pdf-o fa-fw"></i></a>
                <a href="<?= $ruta ?>inventario/excelKardex/" class="btn btn-default btn-lg" data-toggle="tooltip" title="Exportar a Excel"
