...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li><a href="">Agregar y editar M&eacute;todos</a></li>
</ul>
            ...
            <?php if (count($metodos) > 0) {
                ...
                foreach ($metodos as $metodo) {
                    ...
                    <tr>
                        ...
                        <td class="center"><?= $metodo['id_metodo'] ?></td>
                        <td><?= $metodo['nombre_metodo'] ?></td>
                        <td><?= $metodo['tipo_metodo'] ?></td>
...
<script type="text/javascript">
    ...
    function editar(id) {
        ...
        $("#agregar").load('<?= $ruta ?>metodosdepago/form/'+id);
        $('#agregar').modal('show');
    }

    function agregar() {

        $("#agregar").load('<?= $ruta ?>metodosdepago/form');
        $('#agregar').modal('show');
    }
    ...
    var marca = {
        ...
        guardar : function () {
            ...
            if ($("#tipo").val() == '') {
                ...
                $.bootstrapGrowl('<h4>Debe seleccionar un tipo</h4>', {
                    type: growlType,
                    delay: 2500,
                    allow_dismiss: true
                });
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>metodosdepago/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Est&aacute; seguro que desea eliminar el M&eacute;todo de Pago seleccionado?</p>
